...
## **Deep learning = neural network + many layers + big data + high compute.**

- Deep learning is a subset of neural networks — eventhough neural network is bigger in category, deep learning is “bigger” in capability.
- A sports car is a subset of cars, but it’s more powerful than most cars.
...
![Layers](../assets/Section2/image6.png)
...
- Activation function(More on [section 2.15.md](2.15.md)): Non-linear function applied to a node's output (e.g., ReLU, sigmoid, tanh).
